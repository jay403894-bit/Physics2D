...
cl /nologo /c /std:c++20 /EHsc /MDd /Zi /arch:AVX2 /I include /I C:\libs\Threads\include src\SpatialGrid.cpp src\PhysicsWorld.cpp src\PhysicsSystem.cpp
...
cl /nologo /c /std:c++20 /EHsc /MD /O2 /DNDEBUG /Zi /arch:AVX2 /I include /I C:\libs\Threads\include src\SpatialGrid.cpp src\PhysicsWorld.cpp src\PhysicsSystem.cpp
if errorlevel 1 ( echo CL_FAILED & exit /b 1 )
